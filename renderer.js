...
function iniciarMap() {
    var coord = {lat: -34.4780272, lng: -71.4809727};
...
function calculateRoute() {
    ...
    directionsService.route({
        ...
        if (status === 'OK') {
            ...
            const output = `Distance: ${distance.toFixed(2)} km<br>Duration: ${duration.toFixed(2)} hours<br>Average Speed: ${averageSpeed.toFixed(2)} km/h<br>Fuel Used: ${fuelUsed.toFixed(2)} liters`;
...
script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyAWDw7KqSCiPibJf9k-lpyVLdibzcGWKls&callback=iniciarMap`;
script.async = true;
script.defer = true;
